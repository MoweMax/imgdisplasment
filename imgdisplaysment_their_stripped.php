...
<body>
    <header class="header" style="display: none"><nav class="nav" role="navigation"><div class="menu"><div class="menu__logo"><div class="menu__item menu__item--home">
...
! function(e) {
    ...
    var r = function() {
        ...
        c = function() {
            function e() {
                n(this, e), console.log("Hello, this is js"), CSSPlugin.defaultForce3D = !0,
                 window.main = this,
                  u.default.resize(),
                   this.DEV_MODE = !0,
                    this._isIntro = !0,
        ...
        b = function(e) {
            ...
            return s(t, e), a(t, [{
                ...
                value: function() {
                    ...
                    // console.log("MM_@3",this);/Running each frame/
                ...
                value: function() {
                    ...
                    this.dom.classList.add("hiding"), this.scrollable.dom.style.transform = "translate3d(1px," + e + "px,0)"
                }
            }, {
                key: "header",
                get: function() {
    ...
    var n = function() {
        ...
        a = function() {
            function e(t) {
                // console.log("someShit", t);
                //  // defining dom for scrollable
                //     console.log("someShit", this);
        ...
        w = (l = function(e) {
            ...
            return s(t, e), u(t, [{
                ...
                value: function(e) {
                    ...
                    var t = "translate3d(" + this.x + "px," + -this.y + "px,2px)";
    ...
    var l, u = function() {
        ...
        _ = (l = function(e) {
            function t(e) {
                n(this, t);
                // console.log("onScllollInitn", t);
                // console.log("onScllollInitn", e);
            ...
            return s(t, e), u(t, [{
                ...
                key: "updateScroll",
                value: function() {
                    console.log( "updateScroll", this.y);
                          ...
                          this.scaleComp = 1 / this.distoScale,
                           this.visuelContainer.scale.x = this.distoScale, this.visuelContainer.scale.y = this.distoScale,
                            this.visuel.scale.x = this.scaleComp, this.visuel.scale.y = this.scaleComp,
                             u.default.isTouch || (this.displacementTexture = PIXI.Texture.fromImage("/imgdisp_img/nm-04.jpg"),
            ...
            return a(e, [{
                ...
                value: function() {
                    if (!u.default.isTouch) {
                        if (this.scrollable && Math.round(this.scrollable.y) != Math.round(this.scrollY) && this.scroll(this.scrollable.y), TweenLite.to(this, .4, {
                            ...
                            var t = Math.floor(e / (.098 * u.default.width));   //MMwidthPerImgOntext
                ...
                value: function(e) {
                    ...
                    if (!this.lockProject) {
                        ...
                        this._currentProject = t, this._currentImageId = void 0, this._currentProjectOver = e, this.visuelContainer.x = u.default.mouseX, this.visuelContainer.y = u.default.mouseY;
        ...
        d = (s = function() {
            ...
            return a(e, [{
                ...
                value: function(e) {
                    ...
                    // }, 0),
                    e.setBackgroundColor(e._bgColor, !1), e.dom.classList.remove("hidden"), "photography" == e.id && this.cFx.showHome()
                }
            }, {
                key: "start",
                value: function(e, t) {
                    if (this.title && (this.title.destroy(!0), this.title = null), this.tsDuration = 4, this._toHide = e, this._toShow = t, this.holder.alpha = 1,
                    // this.transTL = new TimelineLite({
                    //         paused: !0
                    ...
                    //     }, 0),
                        ...
                        if ("photography" == e.id) {
                            if (!u.default.isTouch) {
                                ...
                                this.titleHolder.y = i, this.titleHolder.scale.x = this.titleHolder.scale.y = 1;
                                //  this.transTL.to(this.titleHolder, .9, {
                                //     y: o,
                                //     ease: Power4.easeInOut
                        ...
                        this.titleHolder.y = r, this.titleHolder.scale.x = this.titleHolder.scale.y = .889;
                        // this.transTL.to(this.titleHolder, .9, {
                        //     y: s,
                        //     ease: Power4.easeInOut
    ...
    var l, u = function() {
        ...
        _ = (l = function(e) {
            ...
            return s(t, e), u(t, [{
                key: "init",
                value: function() {
                    console.log("NOOOOW",this);
                    console.log("NOOOOW",e);
                    // console.log("NOOOOW",t);
                    // console.log("NOOOOW",t);
                    // console.log("NOOOOW",t);
                    // console.log("NOOOOW",t);
                    // console.log("NOOOOW",t);
